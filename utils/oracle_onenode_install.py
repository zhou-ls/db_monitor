...
class OracleOneNodeInstall():
    ...
    def upload_software(self, linux_params):
        ...
        LinuxBase(linux_params).sftp_upload_file(
            '{}oracle-database-preinstall-19c.conf'.format(os.getcwd() + '/utils/oracle_onenode_install/'),
    ...
    def oracle_install(self):
        ...
        LinuxBase(linux_params).sftp_upload_file(
            '{}db_install_onenode.rsp'.format(os.getcwd() + '/utils/oracle_onenode_install/'), '/tmp/db_install.rsp')
    ...
    def oracle_dbca(self):
        ...
        LinuxBase(oracle_params).sftp_upload_file(
            '{}dbca_onenode.rsp'.format(os.getcwd() + '/utils/oracle_onenode_install/'), '/tmp/dbca.rsp')
