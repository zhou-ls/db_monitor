...
class OracleRacOneNodeInstall():
    ...
    def grid_install(self):
        ...
        LinuxBase(linux_params).sftp_upload_file('{}gridsetup_onenode.rsp'.format(self.local_path),
                                                 '/tmp/gridsetup.rsp')
    ...
    def oracle_install(self):
        ...
        LinuxBase(linux_params).sftp_upload_file('{}db_install_onenode.rsp'.format(self.local_path),
                                                 '/tmp/db_install.rsp')
